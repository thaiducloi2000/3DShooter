...
public class GamePopup : MonoBehaviour
{
    ...
    // which popup need data, cast data need to type to using (data can be class, struct, etc)
    public virtual void Show(bool isHideLastPopup = true, object data = null, UnityAction<object> closeCallback = null, bool isShowBackgroundPopup = true, CheckCondition condition = null)
    {
